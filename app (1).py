...
RULINGS = [{'k': 'W', 'en': ['The aux cord', 'I am in charge of the vibe.']},
 {'k': 'W', 'en': ['Passenger princess rights', 'International law.']},
 {'k': 'NM', 'en': ['Skipping the song before it finishes', 'I can though.']},
 {'k': 'NM', 'en': ['The phone at dinner', 'Something more important than our date, Alex?']},
 {'k': 'W', 'en': ['Airport lounges', 'For women, through men.']},
 {'k': 'NM', 'en': ['Being dry', 'Bolivia already claimed that jurisdiction.']},
 {'k': 'W', 'en': ['Battersea', 'The new Bolivia, but with better coffee.']},
 {'k': 'W', 'en': ['Half a croissant', 'A fair and generous prize.']},
 {'k': 'M', 'en': ['Paying for half a croissant', 'His maximum financial contribution.']},
 {'k': 'W', 'en': ['Matcha', 'Green meditation.']},
 {'k': 'M', 'en': ['Protein powder', 'Sand for the soul.']},
 {'k': 'M', 'en': ['Garmin watches', 'Tiny wrist computers for emotional avoidance.']},
 {'k': 'M', 'en': ['Open-water swimming', 'Fine with me, I guess.']},
 {'k': 'W', 'en': ['The better side of the bed', "But I'll accommodate your shoulder issues."]},
 {'k': 'NM', 'en': ['Farting in bed', 'A crime against romance.']},
 {'k': 'M', 'en': ['Overhead lighting', 'Alex loves it, which tells you everything.']},
 {'k': 'W', 'en': ['Bad Bunny', 'You can watch though.']},
 {'k': 'W', 'en': ['Perreo', 'A feminine science.']},
 {'k': 'NM', 'en': ['Clapping off beat', 'A public safety issue.']},
 {'k': 'W', 'en': ['Saying “interesting”', 'For women, and Dylan per se.']},
 {'k': 'NM', 'en': ['Saying “you’re being irrational”', 'Historically unsuccessful. Surprisingly wrong.']},
 {'k': 'NM', 'en': ['The phrase “trust me”', 'Why would we?']},
 {'k': 'NM', 'en': ['The phrase “well actually”', 'Actually what?']},
 {'k': 'NM', 'en': ['Explaining the movie', 'I watched it too.']},
 {'k': 'NM', 'en': ['The last word', 'Are you finished?']},
 {'k': 'NM', 'en': ['Loud sneezing', 'Was that necessary?']},
 {'k': 'NM', 'en': ['The middle armrest', 'Both of them?']},
 {'k': 'W', 'en': ['Moonlight', "She's one of us."]},
 {'k': 'W', 'en': ['Crying', 'An advanced emotional technology.']},
 {'k': 'M', 'en': ['Folding chairs', 'You can sit, I guess.']},
 {'k': 'M', 'en': ['Power tools', "Personally, that's ok with me."]},
 {'k': 'M', 'en': ['Toolboxes', 'Like a jewelry box, but you buy it for yourself.']},
 {'k': 'M', 'en': ['Cargo shorts', 'Yes please hide.']},
 {'k': 'M', 'en': ['Grilling', 'A controlled little fire to feel in charge of.']},
 {'k': 'M', 'en': ['Lawnmowers', 'A loud Saturday companion.']},
 {'k': 'M', 'en': ['Screws and stuff', 'No notes. None.']},
 {'k': 'NM', 'en': ['Seatbelts', 'Thought you were a good driver?']},
 {'k': 'NM', 'en': ['Glasses', 'What do men need to see so badly?']},
 {'k': 'M', 'en': ['Cockroaches', 'Self-explanatory.']},
 {'k': 'W', 'en': ['Leisure time', 'Why would men rest? Tired from lying?']},
 {'k': 'NM', 'en': ['Ladders', 'Who said you could go up?']},
 {'k': 'NM', 'en': ['Directions', 'Lost again? Thought you were a man?']},
 {'k': 'W', 'en': ['Group chats', 'The real government.']},
 {'k': 'NM', 'en': ['Calendars', "You forgot, didn't you?"]},
 {'k': 'NM', 'en': ['Whistling', 'Who taught you that?']},
 {'k': 'NM', 'en': ['Mansplaining', 'Did we ask you to elaborate?']}]

ROASTS = {'right': ['Good job, Harley Quinn.',
 ...
 'wrong': ['Better luck next time, Harley.',
